...
interface IInitialState {
  dataTable: ProductoPost[] | IArticuloManufacturado[]; // Datos de la tabla
  elementActive: null | ProductoPost | IArticuloManufacturado[]; // Elemento activo seleccionado
}
...
const TablaReducer = createSlice({
  ...
  reducers: {
    ...
    setDataTable(state, action: PayloadAction<ProductoPost[] | IArticuloManufacturado[]>) {
